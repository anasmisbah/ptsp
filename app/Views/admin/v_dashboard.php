...
<?= $this->section('css'); ?>
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="<?= base_url('admin_assets/node_modules/jqvmap/dist/jqvmap.min.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('admin_assets/node_modules/weathericons/css/weather-icons.min.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('admin_assets/node_modules/weathericons/css/weather-icons-wind.min.css'); ?>">
  <link rel="stylesheet" href="<?= base_url('admin_assets/node_modules/summernote/dist/summernote-bs4.css'); ?>">
<?= $this->endSection(); ?>
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <ul class="list-unstyled list-unstyled-border">
                <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url('admin_assets/assets/img/avatar/avatar-1.png'); ?>" alt="avatar">
                ...
                <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url('admin_assets/assets/img/avatar/avatar-2.png'); ?>" alt="avatar">
                <div class="media-body">
                ...
                <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url('admin_assets/assets/img/avatar/avatar-3.png'); ?>" alt="avatar">
                <div class="media-body">
                ...
                <li class="media">
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url('admin_assets/assets/img/avatar/avatar-4.png'); ?>" alt="avatar">
                <div class="media-body">
        ...
        <div class="card">
            ...
            <div class="row pb-2">
                ...
                <div class="avatar-item mb-0">
                    <img alt="image" src="<?= base_url('admin_assets/assets/img/avatar/avatar-5.png'); ?>" class="img-fluid" data-toggle="tooltip" title="Alfa Zulkarnain">
                    <div class="avatar-badge" title="Editor" data-toggle="tooltip"><i class="fas fa-wrench"></i></div>
                </div>
                </div>
                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                <div class="avatar-item mb-0">
                    <img alt="image" src="<?= base_url('admin_assets/assets/img/avatar/avatar-4.png'); ?>" class="img-fluid" data-toggle="tooltip" title="Egi Ferdian">
                    <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                </div>
                </div>
                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                <div class="avatar-item mb-0">
                    <img alt="image" src="<?= base_url('admin_assets/assets/img/avatar/avatar-1.png'); ?>" class="img-fluid" data-toggle="tooltip" title="Jaka Ramadhan">
                    <div class="avatar-badge" title="Author" data-toggle="tooltip"><i class="fas fa-pencil-alt"></i></div>
                </div>
                </div>
                <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                <div class="avatar-item mb-0">
                    <img alt="image" src="<?= base_url('admin_assets/assets/img/avatar/avatar-2.png'); ?>" class="img-fluid" data-toggle="tooltip" title="Ryan">
                    <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="summary">
                ...
                <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                    <a href="#">
                        <img class="mr-3 rounded" width="50" src="<?= base_url('admin_assets/assets/img/products/product-1-50.png'); ?>" alt="product">
                    </a>
                    <div class="media-body">
                    ...
                    <li class="media">
                    <a href="#">
                        <img class="mr-3 rounded" width="50" src="<?= base_url('admin_assets/assets/img/products/product-2-50.png'); ?>" alt="product">
                    </a>
                    <div class="media-body">
                    ...
                    <li class="media">
                    <a href="#">
                        <img class="mr-3 rounded" width="50" src="<?= base_url('admin_assets/assets/img/products/product-3-50.png'); ?>" alt="product">
                    </a>
                    <div class="media-body">
        ...
        <div class="card">
            ...
            <ul class="list-unstyled list-unstyled-border">
                ...
                <img class="mr-3 rounded-circle" width="50" src="<?= base_url('admin_assets/assets/img/avatar/avatar-5.png'); ?>" alt="avatar">
                <div class="media-body">
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="#" class="font-weight-600"><img src="<?= base_url('admin_assets/assets/img/avatar/avatar-1.png'); ?>" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                    </td>
                    <td>
...
<?= $this->section('js'); ?>
  <!-- JS Libraies -->
  <script src="<?= base_url('admin_assets/node_modules/simpleweather/jquery.simpleWeather.min.js'); ?>"></script>
  <script src="<?= base_url('admin_assets/node_modules/chart.js/dist/Chart.min.js'); ?>"></script>
  <script src="<?= base_url('admin_assets/node_modules/jqvmap/dist/jquery.vmap.min.js'); ?>"></script>
  <script src="<?= base_url('admin_assets/node_modules/jqvmap/dist/maps/jquery.vmap.world.js'); ?>"></script>
  <script src="<?= base_url('admin_assets/node_modules/summernote/dist/summernote-bs4.js'); ?>"></script>
  <script src="<?= base_url('admin_assets/node_modules/chocolat/dist/js/jquery.chocolat.min.js'); ?>"></script>
  <!-- Page Specific JS File -->
  <script src="<?= base_url('admin_assets/assets/js/page/index-0.js'); ?>"></script>
<?= $this->endSection(); ?>